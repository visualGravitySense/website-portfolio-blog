...
const TeacherComponent = ({ image, title, description, link, showProfile }) => {
    return (
        <div className="teacher-card">
            <img src={image} alt={title} className="teacher-image" />
            <h3 className="teacher-title">{title}</h3>
            <p className="teacher-description">{description}</p>
            
                <a href={link} className="teacher-link" target="_blank" rel="noopener noreferrer">
                    LinkedIn
                </a>
