...
const updateClassesData = async () => {
  ...
  const classesData = {
    ...
    question: "Нужно ли мне уметь программировать?", answer: "Нет, но базовые знания дизайна и ML будут плюсом." ,
    question: "Подойдет ли этот курс начинающим?", answer: "Да, мы разбираем все с нуля, но опыт в дизайне или IT поможет быстрее освоить материал." ,
    question: "Сколько времени займет обучение?", answer: "Около 3 месяцев при средней нагрузке. Но вы можете проходить курс в удобном для вас темпе." ,
